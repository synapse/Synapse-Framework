...
class SimpleCaptcha {
    ...
    public function __construct($config = array()) {
        $this->wordsFile = LIBRARY.'/captcha/resources/words/en.php';
        $this->fontsPath = LIBRARY.'/captcha/resources/fonts/';
    }
